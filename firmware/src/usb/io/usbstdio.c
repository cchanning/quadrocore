...
USBStandardRequestHandler_t* USBStandardRequestHandlerTableGet(void)
{
	...
	{
		int i = 0;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].type = USB_REQUEST_TYPE_STANDARD;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].recipient = USB_REQUEST_TYPE_RECIPIENT_DEVICE;
		...
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].type = USB_REQUEST_TYPE_STANDARD;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].recipient = USB_REQUEST_TYPE_RECIPIENT_DEVICE;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].id = USB_REQUEST_DEVICE_GET_STATUS;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].handlerFuncP = &USBDeviceGetStatus;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].compareValueHighByte = false;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].compareValueLowByte = false;
		...
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].type = USB_REQUEST_TYPE_STANDARD;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].recipient = USB_REQUEST_TYPE_RECIPIENT_DEVICE;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].id = USB_REQUEST_DEVICE_CLEAR_FEATURE;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].handlerFuncP = &USBDeviceClearFeature;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].compareValueHighByte = false;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].compareValueLowByte = false;
		...
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].type = USB_REQUEST_TYPE_STANDARD;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].recipient = USB_REQUEST_TYPE_RECIPIENT_DEVICE;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].id = USB_REQUEST_DEVICE_SET_FEATURE;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].handlerFuncP = &USBDeviceSetFeature;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].compareValueHighByte = false;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].compareValueLowByte = false;
		...
		i++;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].type = USB_REQUEST_TYPE_STANDARD;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].recipient = USB_REQUEST_TYPE_RECIPIENT_INTERFACE;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].id = USB_REQUEST_DEVICE_CLEAR_FEATURE;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].handlerFuncP = &USBDeviceClearFeature;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].compareValueHighByte = false;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].compareValueLowByte = false;
		...
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].type = USB_REQUEST_TYPE_STANDARD;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].recipient = USB_REQUEST_TYPE_RECIPIENT_INTERFACE;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].id = USB_REQUEST_INTERFACE_GET_DESCRIPTOR;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].handlerFuncP = &USBDeviceGetHIDReportDescriptor;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].compareValueHighByte = true;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].compareValueLowByte = false;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].valueHighByte = 0x22;
				
		i++;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].type = USB_REQUEST_TYPE_CLASS;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].recipient = USB_REQUEST_TYPE_RECIPIENT_INTERFACE;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].id = USB_REQUEST_CLASS_SET_HID_REPORT;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].handlerFuncP = &USBDeviceHIDSetLights;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].compareValueHighByte = false;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].compareValueLowByte = true;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].valueLowByte = 0x01; // report id
		
		i++;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].type = USB_REQUEST_TYPE_CLASS;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].recipient = USB_REQUEST_TYPE_RECIPIENT_INTERFACE;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].id = USB_REQUEST_CLASS_GET_HID_REPORT;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].handlerFuncP = &USBDeviceHIDGetLights;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].compareValueHighByte = false;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].compareValueLowByte = true;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].valueLowByte = 0x02; // report id
		
		i++;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].type = USB_REQUEST_TYPE_STANDARD;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].recipient = USB_REQUEST_TYPE_RECIPIENT_ENDPOINT;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].id = USB_REQUEST_DEVICE_GET_STATUS;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].handlerFuncP = &USBDeviceEndpointGetStatus;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].compareValueHighByte = false;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].compareValueLowByte = false;
		...
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].recipient = USB_REQUEST_TYPE_RECIPIENT_ENDPOINT;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].id = USB_REQUEST_DEVICE_CLEAR_FEATURE;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].handlerFuncP = &USBDeviceEndpointClearFeature;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].compareValueHighByte = false;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].compareValueLowByte = false;
		...
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].recipient = USB_REQUEST_TYPE_RECIPIENT_ENDPOINT;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].id = USB_REQUEST_DEVICE_SET_FEATURE;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].handlerFuncP = &USBDeviceEndpointSetFeature;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].compareValueHighByte = false;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].compareValueLowByte = false;
		...
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].type = USB_REQUEST_TYPE_STANDARD;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].recipient = USB_REQUEST_TYPE_RECIPIENT_ENDPOINT;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].id = USB_REQUEST_DEVICE_SYNC_FRAME;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].handlerFuncP = &USBDeviceEndpointSyncFrame;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].compareValueHighByte = false;
		USB_STANDARD_REQUEST_HANDLER_TABLE[i].compareValueLowByte = false;
...
USBStandardRequestHandler_t* USBDeviceStandardRequestResolveHandler(USBStandardRequest_t *usbStandardRequestP)
{
	...
	{
		uint8_t type = (usbStandardRequestP->requestType & USB_REQUEST_TYPE_FLD_TYPE_bm) >> 5;
...
{
	*((uint16_t *)usbControlTransferP->usbDataBufferInP) = 0x0000;
...
{
	*((uint8_t *)usbControlTransferP->usbDataBufferInP) = 0x00;
...
{
	/**
		We have no need of this functionality
	 */
}
...
void USBDeviceIntefaceSetFeature(USBControlTransfer_t *usbControlTransferP)
{
	/**
		We have no need of this functionality
	 */
...
void USBDeviceGetDescriptor(USBControlTransfer_t *usbControlTransferP)
{
	...
	usbStandardDeviceDescriptorP->vendorId = 0x04B3;
	usbStandardDeviceDescriptorP->productId = 0x0001;
...
void USBDeviceGetConfigurationDescriptor(USBControlTransfer_t *usbControlTransferP)
{
	...
	// fill in the HID descriptor
	{
		...
		usbStandardHIDConfigurationDescriptorP->nestedDesciptorLength = 31;
	...
	// fill in the endpoint descriptor
	{
		...
		usbStandardEndpointConfigurationDescriptorP->attributes = 0x03; // interrupt data endpoint
...
void USBDeviceGetHIDReportDescriptor(USBControlTransfer_t *usbControlTransferP)
{
	uint8_t reportDescriptor[31] = 
	{
		...
		0x85, 0x01,                    //   REPORT_ID (1 (USBDeviceHIDSetLights))
		0x95, 0x07,                    //   REPORT_COUNT (7)
		0x09, 0x01,                    //   USAGE (Vendor Usage 1)
		0xB1, 0x02,                    //   FEATURE (Data,Var,Abs)
		0x85, 0x02,                    //   REPORT_ID (2 (USBDeviceHIDGetLights))
		0x95, 0x07,                    //   REPORT_COUNT (7)
		0x09, 0x01,                    //   USAGE (Vendor Usage 1)
		0xB1, 0x02,                    //   FEATURE (Data,Var,Abs)
		0xc0                           // END_COLLECTION
	...
	memcpy(usbControlTransferP->usbDataBufferInP, (ptr_t)reportDescriptor, 31);
	usbControlTransferP->actualLength = 31;
}
